							...
							<div class="card  card-box">
								<div class="card-head">
									...
									<div class="btn-group btn-group-circle">
										...
										<button type="button" class="btn btn-circle-right btn-secondary dropdown-toggle m-r-20" data-toggle="dropdown">
										...
										<!--  <li><a class="btnAfficherModalAjouterNote" href="#" data-toggle="modal" data-target="#modalAjouterNote">Ajouter</a>
											...
											<li class="bg-light">
												<!--<a href="#" data-toggle="modal" data-target="#modalScolarite">Détails</a>-->
													<form:form action="rechercherNote" modelAttribute="rechercher-eleve" id="form_rechercher_note">
									    			   <input type="text" id="idInscription4Note" name="idEleve" value="0" hidden="true"/>
									    			   <input type="text" id="semestre" name="semestre" value="1" hidden="true"/>
														<button type="submit" class="btn btn-light btn_rechercher_note">Détails 1er semestre</button>
													</form:form>
                                         ...
                                         <ul class="dropdown-menu">
										      ...
										      <li class="dropdown-submenu">
										        ...
										        <ul class="dropdown-menu">
										          <li>
										           <form:form action="rechercherBulletin" modelAttribute="eleve" id="form_rechercher_bulletin">
									    			   <input type="text" id="idEleve4Bulletin" name="idInscription" value="0" hidden="true"/>
									    			   <input type="text" id="semestre" name="semestre" value="1" hidden="true"/>
														<button type="submit" id="btnBulletin" class="btn btn-white  btn_rechercher_bulletin1" >Afficher</button>
													</form:form>										         	 
										          </li>
										          <li>
										          	 <form:form action="rechercherDetailsBulletin1" modelAttribute="eleve" id="form_rechercher_details_bulletin">
									    			   <input type="text" id="idInscription4DetailsBulletin" name="idInscription" value="0" hidden="true"/>
														<button type="submit" id="btnDetailsBulletin" class="btn btn-white btn_rechercher_details_bulletin1" >Modifier</button>
													</form:form>
										...
										<div class="btn-group btn-group-circle">
									    			<!--<form:form action="rechercherScolarite" modelAttribute="rechercher-eleve" id="form_rechercher_scolarite">
													...
													<ul class="dropdown-menu bg-light" role="menu">
														<li>
															...
															<form:form action="rechercherScolarite" modelAttribute="eleve" id="form_rechercher_scolarite">
											    			   <input type="text" id=idInscription4Scolarite name="idInscription1" value="0" hidden="true"/>
																<button type="submit" class="btn btn-link btn_rechercher_scolarite">Détails</button>
															</form:form>
														</li>
														<li><button class=" btn btn-link btnAfficherModalVersementk" data-toggle="modal" data-target="#modalAjouterVersement">Ajouter</button>
														</li>
														<li>
															<form:form action="listerScolarite" modelAttribute="eleve" id="form_lister_scolarite">
											    			   <input type="text" id="idInscription1ListeSco" name="idInscription2" value="0" hidden="true"/>
															   <button type="submit" id="btnListeSco" class="btn btn-link btn_lister_scolarite">Modifier / Supprimer</button>
															 </form:form>
														</li>
											...
											<div class="col-lg-12 border-0">
												<div class=" p-1 ">
													...
													<div class="col-lg-4 text-center pl-4 m-0">
														...
														<p class="ml-5"  style="line-height: 12px;"><span id="spanAnneeScolaire" class="h6">${anneeScolaire}</span></p>
														</div>
													</div>																						
												</div>										
											</div>
			                                                 ...
			                                                 <thead class="p-0" style="background-color: #b0b0b0;">                                                      
			                                                  ...
			                                                  <tbody>  
			                                                    ...
			                                                    <tr class="p-0">                                                          
			                                                        ...
			                                                        <td><span id="spanIdEleve" class="h6"  hidden="true"></span><span id="spanNom" class="h6"></span></td>
			                                                    </tr>
			                                                    <tr class="p-0">                                                          
			                                                     ...
			                                                     <tr class="p-0">                                                          
			                                                        ...
			                                                        <td><span id="spanSexe" class="h6"></span></td>
			                                                    </tr>
			                                                    <tr class="p-0">                                                          
			                                                    ...
			                                                    <tr class="p-0">                                                          
			                                                        ...
			                                                        <td><span id="spanClasse" class="h6"></span></td>
			                                                    </tr>                                                                                        
			                                                  </tbody>
			                                      </table>
			                                  </div>                                  
				  ...
				  <div class="row">                                   
						<div class="col-lg-12 border-0 p-0">
								<div class="border-secondary p-0">
									...
									<p class="text-center" style="line-height: 10px;">Année académique <span id="span1AnneeScolaire" class="h6">${anneeScolaire}</span></p>
								</div>																													
						</div>
					</div>
					  ...
					  <div class="row border  border-secondary mt-0">                                   
						<table class="table table-bordered mx-auto" id="tableBulletin">
...
<div class="modal fade" id="modalAjouterVersement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="card-body" id="bar-parent1">
					<form:form action="ajouterVersement" modelAttribute="rechercher-eleve" id="form_ajouter_versement">
						
						<input type="text" id="idInscription4AjoutScolarite" name="idInscription" value="0" hidden="true"/>
...
<div class="modal fade" id="modalModifierVersement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="card-body" id="bar-parent1">
					<form:form action="modifierVersement" modelAttribute="rechercher-eleve" id="form_modifier_versement">
						
						<input type="text" id="idInscription4ModifScolarite" name="idInscription3" value="0" />
...
<div class="modal fade" id="modalSupprimerVersement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="card-body" id="bar-parent1">
					<form:form action="supprimerVersement" modelAttribute="rechercher-eleve" id="form_supprimer_versement">
					        ...
					        <div class="modal-content">
					            ...
					            <div class="modal-body">
					                <div class="card-body" id="bar-parent1">
					                 ...
					                 <form:form action="ajouterNote" modelAttribute="rechercher-eleve" id="form_ajouter_note">
			...
			<div class="modal fade right" id="modalDetailsNote" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 1600;">
			  <div class="modal-dialog modal-lg" style="max-width: 1150px!important;" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body" id="scolarite5">
					 <div class="container">
                        <div class="col-md-12">
                            <!-- Add content here -->											
								<div class="row mt-2">
			...
			<div class="modal-body">
				<div class="card-body" id="bar-parent1">
					<form:form action="modifierBulletin" modelAttribute="eleve" id="form_modifier_bulletin">
                             ...
                             <input type="text" id="idInscription7" name="idInscription7" value="0" hidden="true"/>
                             <input type="text" id="semestre" name="semestre" value="1" hidden="true"/>
...
<div class="modal fade" id="modalModifierScolarite" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-side modal-top-right" role="document">
			...
			<div class="modal-body">
				<div class="card-body" id="bar-parent1">
					<form:form action="modifierVersement" modelAttribute="eleve" id="form_modifier_versement">
						...
						<input type="text" id="idInscription3" name="idInscription3" value="0" hidden="true"/>
						<input type="text" id="mois3" name="mois3" value="0" />
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="m-t-20"> <a href="#" class="btn btn-default mb-2" data-dismiss="modal">Annuler</a>
							<form:form action="supprimerEleve" modelAttribute="rechercher-eleve"  id="form_supprimer_eleve" >
		...
		<div id="modalErreurNote" class="modal fade delete-modal" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">					
						<img src="assets/img/sent.png" alt="" width="50" height="46">				
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="m-t-20"> <a href="#" class="btn btn-default mb-2" data-dismiss="modal">Annuler</a>
							<form:form action="supprimerNote" modelAttribute="rechercher-eleve"  id="form_supprimer_note" >
		...
		<!-- end modal modifier eleve -->		
         ...
         <table id="tabloMatricule" hidden="true">
           <tbody>          
               <tr>
...
<script>
  ...
  <script src="jq_fic/rechercher_note1.js"></script>
  <script src="jq_fic/supprimer_note.js"></script>
  <script src="jq_fic/rechercher_bulletin.js"></script>
  <script src="jq_fic/charger_form_modif_bulletin1.js"></script>
