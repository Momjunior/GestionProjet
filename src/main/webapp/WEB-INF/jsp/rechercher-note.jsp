...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-color logo-dark">
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Recherche de notes</li>
                            </ol>
                        </div>
                    </div>
                                           ...
                                           <form:form action="listerNote" modelAttribute="note" id="form_lister_note">
											  <div class="form-row align-items-center">
											    <div class="col-auto my-1">
											      ...
											      <select class="form-control input-height" id="classe" name="nomClasse">
											    ...
											    <div class="col-auto my-1">
											      ...
											      <select class="form-control input-height" id="categorie" name="nomCategorie">
                                                        <option value="">Choisir...</option>
											    ...
											    <div class="col-auto my-1">
											      <label class="mr-sm-2" for="categorie">Semestre</label>
											    ...
											    <div class="col-auto my-1">
											      <label class="mr-sm-2" for="matiere1">Matière</label>
											      <select class="form-control input-height" id="matiere1" name="matiere1">
                                                        <option value="">Choisir...</option>
											    ...
											    <div class="col-auto my-1">
											      <label class="mr-sm-2" for="typeNote1">Type de note</label>
											    ...
											    <div class="col-auto my-1">
											      <button type="submit" class="btn btn-primary mt-4 ml-3 btn_lister_note">Rechercher</button>
											    </div>
											  </div>
											</form:form>
                                   </div>
  ...
  <script src="jq_fic/lister_note1.js"></script>
