                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Classe</div>
                            </div>
                                       ...
                                       <div class="col-md-12">
                                           <form>											 
											  <div class="form-group">
												...
												<select class="form-control input-height" name="niveau">
...
<div class="row">
	<div class="col-md-12">
		<div class="card card-box">
			<div class="card-head">
				<header>Liste des élèves de la <span id="spanClasse">${maClasse}</span> - Année scolaire <span id="spanAnneeScolaire">${anneeScolaire}</span></header>
				<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalEffectif">EFFECTIF</button>
				<div class="card-body ">
								<div class="btn-group">
                                  ...
                                  <!-- button-group -->
                                  <div class="btn-group">
                                      <button type="button" class="btn btn-danger btn-afficher-modal-statut" data-toggle="modal" data-target="#modalStatutPaiement">Statut Paiement</button>
                                  </div>
                                  <div class="btn-group ml-3">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                          <li>
                                          	<form:form action="rechercherConduiteclasse" modelAttribute="classe" id="form_rechercher_conduite1">
                                          		<input type="text" id="idInscriptionConduite1" name="idInscriptionConduite1" value="0" hidden="true"/>
                                          		<input type="text" id="semestre3" name="semestre3" value="1" hidden="true"/>
			...
			<div class="card-body ">
				<table id="listeEleve" class="display" style="width:100%;">
					...
					<tbody>  
						<c:forEach items="${inscriptions}" var="inscription" varStatus="boucle">
							<tr class="text-center">
								<td>${boucle.count}</td>															
								...
								<td>${inscription.eleve.dateNaiss}</td>
								<td>${inscription.eleve.tel}</td>
								<td>
									<button type="button" id="btnModifierEleve-${inscription.eleve.idEleve}" class="btn btn-info btn-xs btn_charger_form_modifier_eleve" data-toggle="modal" data-target="#modalModifierEleve">
										<i class="fa fa-edit "></i>
									</button> 
									<button type="button" id="btnSupprimerEleve-${inscription.eleve.idEleve}" class="btn btn-danger btn-xs btn_charger_form_supprimer_eleve" data-toggle="modal" data-target="#modalSupprimerEleve">
								...
								<td>
									...
									<div class="btn-group btn-group-circle">
                                         ...
                                         <ul class="dropdown-menu" role="menu">
                                             <form:form action="rechercherNote" modelAttribute="eleve" id="form_rechercher_note${inscription.idInscription}">
							    			   <input type="text" id="idInscription4Note${inscription.idInscription}" name="idInscription4" value="${inscription.idInscription}" hidden="true"/>
											   <button type="submit" id="btnNote-${inscription.idInscription}" class="btn btn-link btn_rechercher_note">Détails 1er semestre</button>
											 </form:form>
											 
											 <form:form action="rechercherNote" modelAttribute="eleve" id="form_rechercher_note">
							    			   <input type="text" id="idInscription4" name="idInscription4" value="${inscription.idInscription}" hidden="true"/>
									...
									<div class="btn-group btn-group-circle">
                                         ...
                                         <ul class="dropdown-menu" role="menu">
                                             <form:form action="rechercherScolarite" modelAttribute="eleve" id="form_rechercher_scolarite${inscription.idInscription}">
							    			   <input type="text" id="idInscription1Sco${inscription.idInscription}" name="idInscription1" value="${inscription.idInscription}" hidden="true"/>
											   <button type="submit" id="btnSco-${inscription.idInscription}" class="btn btn-link btn_rechercher_scolarite">Détails</button>
											 </form:form>
                                             <li>
                                             	<button type="button" id="btnAfficherModalVersement-${inscription.idInscription}" class="btn btn-link btn_charger_form_ajouter_versement" data-toggle="modal" data-target="#modalAjouterVersement">Ajouter</button>
                                             </li>
                                             <li>
                                             	<form:form action="listerScolarite" modelAttribute="eleve" id="form_lister_scolarite${inscription.idInscription}">
								    			   <input type="text" id="idInscription1ListeSco${inscription.idInscription}" name="idInscription2" value="${inscription.idInscription}" hidden="true"/>
												   <button type="submit" id="btnListeSco-${inscription.idInscription}" class="btn btn-link btn_lister_scolarite">Modifier / Supprimer</button>
												 </form:form>
                                             </li>                                            
                                         </ul>
                                     </div>
                                     ...
                                     <div class="btn-group btn-group-circle">
                                         ...
                                         <ul class="dropdown-menu">
										      ...
										      <li class="dropdown-submenu">
										        ...
										        <ul class="dropdown-menu">
										          <li>
										           <form:form action="rechercherBulletin1" modelAttribute="eleve" id="form_rechercher_bulletin${inscription.idInscription}">
									    			   <input type="text" id="idInscriptions${inscription.idInscription}" name="idInscription" value="${inscription.idInscription}" hidden="true"/>
														<button type="submit" id="btnBulletin-${inscription.idInscription}" class="btn btn-white btn_rechercher_bulletin1" >Afficher</button>
													</form:form>										         	 
										          </li>
										          <li>
										          	 <form:form action="rechercherDetailsBulletin1" modelAttribute="eleve" id="form_rechercher_details_bulletin${inscription.idInscription}">
									    			   <input type="text" id="idInscriptionss${inscription.idInscription}" name="idInscription" value="${inscription.idInscription}" />
														<button type="submit" id="btnDetailsBulletin-${inscription.idInscription}" class="btn btn-white btn_rechercher_details_bulletin1" >Modifier</button>
													</form:form>
...
<div class="modal fade" id="modalEffectif" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
					  ...
					  <div class="row mt-2">
						  ...
						  <div class="col-lg-4">
							  <div class="panel border-secondary">
								  <div class="panel-body text-center h5 p-0">EFFECTIF de la ${maClasse}</div>
							  </div>
						  </div>
						  <div class="col-lg-4">
					  ...
					  <div class="row p-4 border-0  border-secondary mt-0">                                   
						  <table class="table table-bordered mytable" id="table-scolarite1" >
									  ...
									  <!----- 1ere ligne ------------------>
										  ...
										  <tr class="p-0">
											  <td colspan="2"><p class="m-2"  style="line-height: 14px;">Nombre d'élèves:    <span class="h6">${effectif}</span></p></td>
										  </tr>
					            ...
					            <div class="modal-body">
                                    ...
                                    <form:form action="ajouterNote" modelAttribute="note" id="form_ajouter_note">
                                        <div class="form-body">
                                           ...
                                           <div class="form-group">
											<label for="recipient-name" class="col-form-label">Ajoutez les notes des élèves:</label>
										  </div>

										 <c:forEach items="${inscriptions}" var="inscription" varStatus="boucle">
											  <div class="form-group row">
												<label class="control-label col-md-3">${inscription.eleve.prenom} ${inscription.eleve.nom}
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" class="form-control" id="note_${inscription.idInscription}" name="note_${inscription.idInscription}" value="">
													<span class="clsNotAvailable erreur_note_${inscription.idInscription}" ></span>
												</div>
											 </div>
										 </c:forEach>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form:form action="listerNote" modelAttribute="note" id="form_lister_note">
					...
					<input id="idDetailClasse" name="idDetailClasse"  type="text"  hidden="true">
					<div class="form-body">
						<div class="form-group row">
							<label class="control-label col-md-3">Semestre
								<span class="required"> * </span>
 ...
 <div class="modal fade" id="modalStatutPaiement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 1600;">
  ...
  <!-- start ajouter scolarité -->
			<div class="modal fade" id="modalConduite" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog modal-lg " role="document">
					        <div class="modal-content">
					            ...
					            <div class="modal-body">
					                <div class="card-body" id="bar-parent1">
                                    <form:form action="modifierConduiteClasse" modelAttribute="classe" id="form_modifier_conduite_classe">
                                        <div class="form-body">
                                        	<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                <input type="text" class="form-control" id="idDetailClasse3" name="idDetailClasse" hidden="true">
										 ...
										 <p class="clsNotAvailable resultat13 text-center"> </p>
										  <button type="button" class="btn btn-primary btn-modifier-conduite-classe">Valider</button>
		...
		<div class="modal fade" id="modalMatiere" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog modal-lg" role="document">
					        <div class="modal-content">
					            <div class="modal-header">
					                <h4 class="modal-title" id="exampleModalLabel">Liste des matières enseignées</h4>
					                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					                    <span aria-hidden="true">&times;</span>
					                </button>
					            </div>
                    	...
                    	<div class="col-sm-12">
                             <div class="card-box">
                                 <div class="card-head">
									<form>							 
									  <div class="form-group">
										<label for="recipient-name" class="col-form-label">Nom de la matière:</label>
										<input type="text" class="form-control" id="recipient-name">
									  </div>
									  <button type="button" class="btn btn-primary">Ajouter matière</button>
									</form>                                 
								</div>
                                 <div class="card-body ">
                                 <div class="table-scrollable">
                                 	<table id="mainTable" class="table table-striped">
			                            ...
			                            <tbody>
			                                <tr>
			                                    <td>1</td>
			                                    <td>Mastère européen Management Opérationnel du Développement Durable</td>
			                                    <td>
											...
											<tr>
			                                    <td>2</td>
			                                    <td>Mastère européen Management Environnemental et Energétique</td>
			                                    <td>
												   <button class="btn btn-danger btn-xs">
														<i class="fa fa-trash-o "></i>
													</button> 
...
<div class="modal fade" id="modalBulletin1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
				  ...
				  <div class="row">                                   
						<div class="col-lg-12 border-0 p-0">
								<div class="border-secondary p-0">
									...
									<p class="text-center" style="line-height: 10px;">Année académique <span id="span1AnneeScolaire" class="h6"></span></p>
								</div>																													
						</div>
					</div>
					  <div class="row border-top border-dark">
					   ...
					   <div class="row border  border-secondary mt-0">                                   
						<table class="table table-bordered" id="tableBulletin">
							...
							<tbody>
								<tr> 
									...
									<td style="font-size: 0.875em; LINE-HEIGHT:1px;">
										<p class="m-0 text-center"  style="line-height: 14px;"> <span id="assiduite" class="h6"></span></p>
									</td>									
								</tr>
							</tbody>
						</table>					
 ...
 <div class="modal fade" id="modalEmploi1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" style="max-width: 1550px!important;" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel"><button onclick="generatePDF()" class=" float-right btn bg-info btn-rounded"><i class="fa fa-print"></i> Imprimer</button></h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
				...
				<div class="card-body" id="bar-parent1">
				  <div class="row" style="background-color: #b0b0b0;">                                     
					  ...
					  <div class="row">                                   
						<div class="col-lg-12 border-0 p-0">
								<div class="border-secondary p-0">
									<p class="panel-body text-center h5 p-0" style="line-height: 15px;"><u>EMPLOI DU TEMPS DU 1ER SEMESTRE - </u><span id="classEmploi"></span></p>
								</div>																													
						</div>
					</div>
					  
					<div class="row bg-white pt-5" id="emploi1">					 
                        <div class="col-md-12">
                           <table class="table table-bordered mytable" id="table-emploi">
                                                <thead>
                                                    <tr style="text-align:center; background-color: #b0b0b0;">
                                                        <th style="width:10%;">Horaires</th>
                                                ...
                                                <tbody>
													...
													<tr>
                                                        ...
                                                        <td rowspan="9" class="bg-light"><strong>Anglais</strong></td>
                                                        <td></td>
														<td></td>
														<td rowspan="5" class="bg-light"><strong>Maths</strong></td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
													<tr>
                                                    ...
                                                    <tr>
                                                        <td><strong>10h00</strong></td>
                                                        <td></td>
                                                        <td rowspan="5" class="bg-light"><strong>Histoire / Geo</strong></td>
														<td rowspan="5" class="bg-light"><strong>PC</strong></td>
                                                        <td></td>
                                                    </tr>
													<tr>
													...
													<tr>
                                                        ...
                                                        <td rowspan="3" class="bg-light"><strong>SVT</strong></td>
														<td></td>
                                                        <td></td>
                                                    </tr>
													<tr>
													...
													<tr>
                                                        ...
                                                        <td></td>
                                                        <td></td>
														<td rowspan="3" class="bg-light"><strong>Français</strong></td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
													<tr>
													...
													<tr>
                                                        ...
                                                        <td rowspan="7" class="bg-light"><strong>Maths</strong></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
													...
													<tr>
                                                        ...
                                                        <td></td>
                                                        <td rowspan="5" class="bg-light"><strong></strong></td>
														<td></td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
...
<div class="modal fade" id="modalModifierBulletin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script>
		...
		$(document).ready(function() {
			  ...
			  var anneeScolaire = $("#spanAnneeScolaire").text();
			  var maClasse = $("#spanClasse").text();
		      var titre = "Scolarité "+maClasse+' - Année scolaire: '+anneeScolaire+' - Date: '+d + "-" + m + "-" + y;			  
			  
		   // DataTable
			  var table = $('#tableStatutPaiement').DataTable({
				  "language": {
		        		"url": "French.json"
		            },
				  dom: 'lBfrtip',
      ...
      function generatePDF() {
        // Choose the element that our invoice is rendered in.
        var element = document.getElementById('emploi1');
        html2pdf()
        .from(element)
        .set({
            margin:       [0, 30, 0 ,30],
        ...
        .get('pdf').then(function (pdf) {
          ...
          for (let i = 1; i <= totalPages; i++) {
            ...
            pdf.setFontSize(10);
            pdf.setTextColor(150);
          //entête  pdf.text("my header text", 10, 10);
          } 
        }).save();
	...
	$(document).ready(function(){
	    ...
	    $("#listeEleve").on('click','.btn_detail_eleve',function(){
			
	    	 var id = $(this).attr('id').replace(/btnDetailEleve-/, '');
	    	 window.open("eleve?id="+id, "_blank");
   ...
   <script> 
	...
	<script> 
	$(document).ready(function(){
		$(".btn-afficher-modal-statut").click(function(event) {
			
			var url_params = new URLSearchParams(window.location.search);
	        
	        var id = url_params.get('id');
	        
	        $('#idDetailClasse2').val(id);
	 ...
	 <script> 
	$(document).ready(function(){
		$(".btn-annuler-note").click(function(event) {
			$("#form_charger_note")[0].reset() ;
	    });
	});
	</script>
	<script> 
	$(document).ready(function(){
		$("#btnEmploi1").click(function(event) {
			var maClasse = $("#spanClasse").text();console.log("classe "+maClasse);
			$("#classEmploi").text(maClasse);
	    });
	});
	</script>
   <script>
    ...
    <script src="jq_fic/modifier_versement.js"></script>
 	...
 	<script src="jq_fic/rechercher_bulletin1.js"></script>
    ...
    <script src="jq_fic/rechercher_conduite.js"></script>
    <script src="jq_fic/modifier_conduite_classe.js"></script>
  </body>
</html>