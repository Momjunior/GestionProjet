					 ...
					 <div class="row pl-5">
						<div class=" w-50">
							<div class="card  card-box  p-2">
								...
								<div class="card-body ">
									<div class="row">
                                           <form:form action="rechercherClasse2" modelAttribute="classe" id="form_rechercher_classe">
											  <div class="form-row align-items-center">
											    ...
											    <div class="col-auto my-1" style="width:20%;">
											      <label class="mr-sm-2" for="classe">Année début</label>
											      <input type="text" id="debut" name="debut" data-required="1" class="form-control" />
                                                    <span class="clsNotAvailable erreur_debut" ></span>
											    </div>
											    <div class="col-auto my-1" style="width:20%;">
											      <label class="mr-sm-2" for="categorie">Année fin</label>
											      <input type="text" id="fin" name="fin" data-required="1" class="form-control" />
                                                    <span class="clsNotAvailable erreur_fin" ></span>
											    </div>
											    <div class="col-auto my-1">
											      <button type="submit" class="btn btn-primary mt-5 ml-3 btn-rechercher-classe">Rechercher</button>
											    </div>
											  </div>
											</form:form>
                                   </div>
...
<!-- BEGIN LIST -->
<!-- BEGIN LIST -->
<div class="row divHide bg-success">
	<div class="col-md-12">
					        ...
					        <div class="modal-content">
					            ...
					            <div class="modal-body">
                                    ...
                                    <form:form action="modifierNote" modelAttribute="note" id="form_modifier_note">
                                        ...
                                        <input type="text" id="idNote" name="idNote" value="0"/>
...
<!-- end rechercher note -->
  ...
  <div id="modal-ajout-note-reussi" class="modal fade delete-modal" role="dialog">
    ...
    <!-- end js include path -->
    <script src="jq_fic/rechercher_classe2.js"></script>
