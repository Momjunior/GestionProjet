...
<head>
    ...
    <title>Ecole | Liste Classe</title>
    <!-- google font -->
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-color logo-dark">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Liste des classes - Année scolaire <span id="spanAnneeScolaire">${anneeScolaire}</span> </header>
                                    
                                </div>
                                <div class="card-body ">
                                    <table id="listeClasse" class="display" style="width:100%;">
                                        <thead>
                                        ...
                                        <tbody>
	                                          <c:forEach items="${detailClasses}" var="detailClasse" varStatus="boucle">
												<tr class="text-center">
													<td>${boucle.count}</td>															
													<td>${detailClasse.classe.nomClasse} ${detailClasse.categorieClasse.nomCategorie}</td>
													<td>${detailClasse.effectif}</td>
													<td>${detailClasse.effectifGarcon}</td>
													<td>${detailClasse.effectifFille}</td>
													<td>
													   	 <button type="button" id="btnDetailClasse-${detailClasse.idDetailClasse}" class="btn red btn-outline m-b-10 btn_detail_classe">DETAILS</button>
													</td>												
												</tr>
											</c:forEach>                                        
                                        </tbody>
    ...
    <script>
  	$(document).ready(function() {
        ...
        var titre = 'Liste des classes - Année scolaire: '+anneeScolaire+' - Date: '+d + "-" + m + "-" + y;
        
        
     // DataTable
	    var table = $('#listeClasse').DataTable({
	    	"language": {
        		"url": "French.json"
            },
	    	dom: 'lBfrtip',
	    	  buttons: [
		            ...
		            },
		            {
		                extend: 'pdfHtml5',
		                exportOptions: {
							columns: [ 0, 1, 2, 3, 4 ] //nombre de colonnes
						},
   ...
   <script>
	...
	$(document).ready(function(){
	    ...
	    $("#listeClasse").on('click','.btn_detail_classe',function(){
			
	    	 var id = $(this).attr('id').replace(/btnDetailClasse-/, '');
	    	 console.log("id est "+id);
	    	 window.open("classe?id="+id, "_blank");
