...
//	$('#tableNote1').DataTable().clear().draw();
  ...
  else
  {
   ...
   if ((erreur_classe !== '')||(erreur_categorie !== '')||(erreur_debut !== '') ||(erreur_fin !== ''))
     {         
	  return false;
     }
  else
		    ...
		    $.each(result, function(i, obj) {						
					 ...
					 t.row.add( [
                                     ...
                                     <div class="btn-group btn-group-circle">\
                                         ...
                                         <ul class="dropdown-menu">\
										      <li class="dropdown-submenu">\
										        ...
										        <ul class="dropdown-menu">\
										          <li>\
										           <form:form action="rechercherBulletin1" modelAttribute="eleve" id="form_rechercher_bulletin'+obj.idInscription+'">\
		               ...
		               j++;	
						...
						var e = $('<div class="form-group row"><label class="control-label col-md-3">'+obj.prenom+' '+obj.nom+'<span class="required"> * </span></label><div class="col-md-5"><input type="text" class="form-control" id="note_'+obj.idInscription+'" name="note_'+obj.idInscription+'" value="14"><span class="clsNotAvailable erreur_note_idInscription" ></span></div></div>');
		        	    $('#divListeEleve').append(e);   				        	
		        	});	
		        	$('.spanClasse').html(classe);
		        	$('#idDetailClasse1').val(idDetailClasse);	
		        	$('#idDetailClasse').val(idDetailClasse);
